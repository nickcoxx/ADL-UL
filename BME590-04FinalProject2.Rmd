---
title: "BME 590.04 Final Project P2"
...
wlk.aov2 <- aov(Motion ~ Direction * Gender, data = b)
Anova(wlk.aov2, type = "III")
summary(wlk.aov2)

TukeyHSD(wlk.aov2, which = "Gender")
TukeyHSD(wlk.aov2, which = "Direction")
